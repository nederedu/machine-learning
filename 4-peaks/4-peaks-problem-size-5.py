...
def risk_function(state):
    ...
    children = state[4]  # Number of children: 0-5
    
    return age * 0.2 + bmi * 0.3 + smoker * 2.0 + region * 0.1 + children * 0.5
...
problem_size = 5  # Increased to 5 to include the number of children
